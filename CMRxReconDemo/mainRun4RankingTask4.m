...
basePath = '/home2/Raw_data/MICCAIChallenge2024/GroundTruth/'; % the superior directory of 'MultiCoil/'
mainSavePath = '/home2/Raw_data/MICCAIChallenge2024/GroundTruth4Ranking'; % output path
...
for iDataType = 1:length(dataTypeList)
    taskDir = fullfile(basePath, coilInfo, dataTypeList{iDataType}, setName, 'FullSample');
